...
class TalentController extends AbstractController
{
    ...
    public function addTalent(Request $request, EntityManagerInterface $entityManager): Response
    {
    ...
    public function talentList(ManagerRegistry $doctrine): Response
    {
        $talents = $doctrine->getRepository(Talent::class)->findBy([], ["id" => "ASC"]);
    ...
    public function updateTalent(int $id, Request $request, EntityManagerInterface $entityManager, ManagerRegistry $doctrine): Response
    {
        $talent = $doctrine->getRepository(Talent::class)->find($id);
